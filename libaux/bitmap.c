...
/*
  Makes loop through bitmap and calculates the number of used/unused blocks in
  ...
  actual returned one or not. Also it is used for calculating used blocks of
