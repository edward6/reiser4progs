...
extern errno_t repair_filter_before_traverse(reiser4_joint_t *, reiser4_item_t *, 
    void *);
extern errno_t repair_filter_after_traverse(reiser4_joint_t *, reiser4_item_t *, 
    void *);
extern errno_t repair_filter_setup_traverse(reiser4_joint_t *, reiser4_item_t *, 
    void *);
extern errno_t repair_filter_update_traverse(reiser4_joint_t *, reiser4_item_t *, 
    void *);
