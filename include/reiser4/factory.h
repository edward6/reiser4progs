...
extern void reiser4_plug_close(plug_class_t *class);
...
extern errno_t reiser4_factory_load(char *name);

errno_t reiser4_plug_open(char *name, plug_class_t *class);
#else
extern errno_t reiser4_plug_open(plug_init_t init,
				 plug_fini_t fini,
				 plug_class_t *class);

extern errno_t reiser4_factory_load(plug_init_t init,
				    plug_fini_t fini);
#endif
