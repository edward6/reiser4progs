...
extern errno_t reiser4_node_traverse(blk_t blk, reiser4_open_func_t open_func, 
    reiser4_handler_func_t handler_func, reiser4_setup_func_t before_func, 
    reiser4_setup_func_t setup_func, reiser4_setup_func_t update_func, 
    reiser4_setup_func_t after_func, void *data);
