...
/* Returns TRUE if items are mergeable. That is if they belong to the 
   ...
   FIXME-VITALY->UNMA: key->compshort should be used instead -- it is 
   not clear why only locality is compared here -- key plugin knows why.
   Plus, it compares minor also. */
