/* Copyright (C) 2001, 2002, 2003 by Hans Reiser, licensing governed by
   ...
   cde_large.h -- reiser4 directory with large key. */
...
#define ob_get_ordering(ob)		    LE64_TO_CPU(*((d64_t *)(ob)->ordering))
#define ob_set_ordering(ob, val)	    (*(d64_t *)(ob)->ordering) = CPU_TO_LE64(val)
...
#define ha_get_ordering(ha)		    LE64_TO_CPU(*((d64_t *)(ha)->ordering))
#define ha_set_ordering(ha, val)	    (*(d64_t *)(ha)->ordering) = CPU_TO_LE64(val)
...
typedef struct cde_large cde_large_t;
