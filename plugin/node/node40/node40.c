			   ...
			   node40_t *node, rpos_t *pos)
{
	...
	aal_assert("umka-1631", node != NULL);
			    ...
			    shift_hint_t *hint)
{
	...
	aal_assert("umka-1622", src_node != NULL);
	aal_assert("umka-1623", dst_node != NULL);
				...
				shift_hint_t *hint)
{
	...
	aal_assert("umka-1621", src_node != NULL);
	aal_assert("umka-1619", dst_node != NULL);
