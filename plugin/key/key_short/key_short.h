...
typedef enum {
	/* File name key type */
	KEY_SHORT_FILENAME_MINOR = 0,
    
	/* Stat-data key type */
	KEY_SHORT_STATDATA_MINOR = 1,
    
	/* File attribute name */
	KEY_SHORT_ATTRNAME_MINOR = 2,
    
	/* File attribute value */
	KEY_SHORT_ATTRBODY_MINOR = 3,
    
	/* File body (tail or extent) */
	KEY_SHORT_FILEBODY_MINOR = 4,
	KEY_SHORT_LAST_MINOR
} key_short_minor_t;
...
KEY_SHORT_FIELD_HANDLER(minor, TYPE, key_short_minor_t);
