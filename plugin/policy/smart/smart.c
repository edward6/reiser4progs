...
static reiser4_plugin_t smart_plugin = {
	.cl    = CLASS_INIT,
	.id    = {TAIL_SMART_ID, 0, POLICY_PLUGIN_TYPE},
	.label = "smart",
...
static reiser4_plugin_t *smart_start(reiser4_core_t *c) {
	return &smart_plugin;
}

plugin_register(smart, smart_start, NULL);
#endif
