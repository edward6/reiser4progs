/*
    avatar.c -- the real personalisation of the reiser4 on-disk node. The libreiser4
...
errno_t reiser4_avatar_move(
	...
	if (src_avatar != src_avatar->tree->root)
	    reiser4_avatar_close(src_avatar);
    }
